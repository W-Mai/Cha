...
pub(crate) fn project_root() -> String {
...
pub(crate) fn cmd_publish(dry_run: bool) -> Result {
    let root = project_root();
...
pub(crate) fn read_workspace_version(root: &str) -> Result<String> {
